...
用法:
    ...
    python3 downgrade.py --stok STOK --fw file/R3600_1.0.17.bin
    python3 downgrade.py --ip 192.168.31.1 --pwd 12345678 --fw file/R3600_1.0.17.bin
"""
...
def downgrade(ip: str, stok: str, fw_path: str) -> dict:
    ...
    print(json.dumps({"status": "upload_ok", "downgrade": is_downgrade}), file=sys.stderr)

    # Step 2: 设置降级标志（web 页面，非 JSON）
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='AX3600 固件降级',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            '示例:\n'
            '  python3 downgrade.py --fw file/R3600_1.0.17.bin\n'
            '  python3 downgrade.py --stok xxx --fw file/R3600_1.0.17.bin\n'
            '  python3 downgrade.py --ip 192.168.31.1 --pwd 12345678 --fw file/R3600_1.0.17.bin\n'
        ))
    ...
    ret = downgrade(args.ip, stok, args.fw)
