...
def upload_firmware(stok, sysauth):
    ...
    try:
        ...
        # 构造URL
        url = f'http://192.168.10.1/cgi-bin/luci/;stok={stok}/api/JCGFirmware/upload_firmware'
...
def check_firmware(stok, sysauth):
    ...
    try:
        # 构造URL
        url = f'http://192.168.10.1/cgi-bin/luci/;stok={stok}/api/JCGFirmware/check_firmware'
